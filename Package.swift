...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            checksum: "358b5a9ddc9186c08814f1e7ca530842f9503c0e6af23355f396a9dd16966f14"
        ),
        .binaryTarget(
            name: "libSDL2_image",
            url: "https://github.com/kivyswiftlink/SDL2Core/releases/download/311.0.14/libSDL2_image.zip",
            checksum: "b232a5af0fcc027303e6d906350774c6725e23ca48bc313b12b617584109e89e"
        ),
        .binaryTarget(
            name: "libSDL2_mixer",
            url: "https://github.com/kivyswiftlink/SDL2Core/releases/download/311.0.14/libSDL2_mixer.zip",
            checksum: "edd501da7b400dc5fd0f64cdeea228999f56d50572d089c99a8dfd28e4e676a7"
        ),
        .binaryTarget(
            name: "libSDL2_ttf",
            url: "https://github.com/kivyswiftlink/SDL2Core/releases/download/311.0.14/libSDL2_ttf.zip",
            checksum: "366f057b703305ecd47dbd912b123bb74302c1083daf307ee109bfc976da1489"
        )
    ]
)
